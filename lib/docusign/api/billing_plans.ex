...
defmodule DocuSign.Api.BillingPlans do
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :include_metadata (String.t): When set to **true**, the &#x60;canUpgrade&#x60; and &#x60;renewalStatus&#x60; properities are included the response and an array of &#x60;supportedCountries&#x60; is added to the &#x60;billingAddress&#x60; information.
    - :include_successor_plans (String.t): When set to **true**, excludes successor information from the response.

  ## Returns

  {:ok, %DocuSign.Model.AccountBillingPlanResponse{}} on success
  {:error, info} on failure
  """
  @spec billing_plan_get_billing_plan(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, DocuSign.Model.AccountBillingPlanResponse.t()} | {:error, Tesla.Env.t()}
  def billing_plan_get_billing_plan(connection, account_id, opts \\ []) do
    ...
    |> decode(%DocuSign.Model.AccountBillingPlanResponse{})
  end
  ...
  {:ok, %DocuSign.Model.DowngradRequestBillingInfoResponse{}} on success
  {:error, info} on failure
  """
  ...
  def billing_plan_get_downgrade_request_billing_info(connection, account_id, _opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%DocuSign.Model.DowngradRequestBillingInfoResponse{})
  end
  ...
  - account_id (String.t): The external account number (int) or account ID GUID.
  - opts (KeywordList): [optional] Optional parameters
    - :downgrade_billing_plan_information (DowngradeBillingPlanInformation):

  ## Returns

  {:ok, %DocuSign.Model.DowngradePlanUpdateResponse{}} on success
  {:error, info} on failure
  """
  @spec billing_plan_put_downgrade_account_billing_plan(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, DocuSign.Model.DowngradePlanUpdateResponse.t()} | {:error, Tesla.Env.t()}
  def billing_plan_put_downgrade_account_billing_plan(connection, account_id, opts \\ []) do
    optional_params = %{
      :downgradeBillingPlanInformation => :body
    }
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%DocuSign.Model.DowngradePlanUpdateResponse{})
  end
