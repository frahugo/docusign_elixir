...
defmodule DocuSign.Api.BulkSend do
  ...
  Gets the general status of a specific bulk send batch such as:  - number of successes - number pending - number of errors  The &#x60;bulkErrors&#x60; property of the response object contains more information about the errors.
  ...
  {:ok, %DocuSign.Model.BulkSendBatchStatus{}} on success
  ...
  @spec bulk_send_v2_batch_get_bulk_send_batch_status(
          ...
          String.t(),
          keyword()
        ) :: {:ok, DocuSign.Model.BulkSendBatchStatus.t()} | {:error, Tesla.Env.t()}
  def bulk_send_v2_batch_get_bulk_send_batch_status(
    ...
    |> decode(%DocuSign.Model.BulkSendBatchStatus{})
  end
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :count (String.t): The number of results to report. Must be a value from 1 to 1000.  Default: 100
    - :start_position (String.t): The start position for results. Essentially the number of results to skip before collecting them. Must be a value greater than 0.
    - :status (String.t): The kind of results to collect. Must be one of:  - all - failed - sent - queued

  ## Returns

  {:ok, %DocuSign.Model.BulkSendBatchSummaries{}} on success
  {:error, info} on failure
  """
  @spec bulk_send_v2_batch_get_bulk_send_batches(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, DocuSign.Model.BulkSendBatchSummaries.t()} | {:error, Tesla.Env.t()}
  def bulk_send_v2_batch_get_bulk_send_batches(connection, account_id, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%DocuSign.Model.BulkSendBatchSummaries{})
  end
  ...
  - opts (KeywordList): [optional] Optional parameters
    - :bulk_send_batch_request (BulkSendBatchRequest):
  ...
  {:ok, %DocuSign.Model.BulkSendingListSummaries{}} on success
  {:error, info} on failure
  """
  @spec bulk_send_v2_crud_delete_bulk_send_list(
          ...
          String.t(),
          keyword()
        ) :: {:ok, DocuSign.Model.BulkSendingListSummaries.t()} | {:error, Tesla.Env.t()}
  def bulk_send_v2_crud_delete_bulk_send_list(
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%DocuSign.Model.BulkSendingListSummaries{})
  end
  ...
  {:ok, %DocuSign.Model.BulkSendingList{}} on success
  {:error, info} on failure
  """
  @spec bulk_send_v2_crud_get_bulk_send_list(
          ...
          String.t(),
          keyword()
        ) :: {:ok, DocuSign.Model.BulkSendingList.t()} | {:error, Tesla.Env.t()}
  def bulk_send_v2_crud_get_bulk_send_list(connection, account_id, bulk_send_list_id, _opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%DocuSign.Model.BulkSendingList{})
  end
  ...
  {:ok, %DocuSign.Model.BulkSendResponse{}} on success
  {:error, info} on failure
  """
  @spec bulk_send_v2_send_post_bulk_send_request(
          ...
          String.t(),
          keyword()
        ) :: {:ok, DocuSign.Model.BulkSendResponse.t()} | {:error, Tesla.Env.t()}
  ...
  {:ok, %DocuSign.Model.BulkSendTestResponse{}} on success
  {:error, info} on failure
  """
  @spec bulk_send_v2_test_post_bulk_send_test_request(
          ...
          String.t(),
          keyword()
        ) :: {:ok, DocuSign.Model.BulkSendTestResponse.t()} | {:error, Tesla.Env.t()}
  def bulk_send_v2_test_post_bulk_send_test_request(
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%DocuSign.Model.BulkSendTestResponse{})
  end
end
