...
defmodule DocuSign.Api.FavoriteTemplates do
  ...
  {:ok, %DocuSign.Model.FavoriteTemplatesInfo{}} on success
  {:error, info} on failure
  """
  @spec favorite_templates_get_favorite_templates(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, DocuSign.Model.FavoriteTemplatesInfo.t()} | {:error, Tesla.Env.t()}
  def favorite_templates_get_favorite_templates(connection, account_id, _opts \\ []) do
    ...
    |> decode(%DocuSign.Model.FavoriteTemplatesInfo{})
  end
  ...
  - account_id (String.t): The external account number (int) or account ID GUID.
  - opts (KeywordList): [optional] Optional parameters
    - :favorite_templates_info (FavoriteTemplatesInfo):
